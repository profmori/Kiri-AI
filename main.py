...
if __name__ == '__main__':
    ...
    special_card_list = [
        Card(Action('kesa strike', begin_stance='heaven', end_stance='earth', strike_min=0, strike_range=1, single_use=True)),
        Card(Action('zan-tetsu strike', begin_stance='earth', end_stance='heaven', strike_min=2, strike_range=1, single_use=True)),
    ...
    p1.hand = basic_card_list
    print(p1.return_actions())
